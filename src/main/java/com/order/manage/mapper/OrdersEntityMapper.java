...
public class OrdersEntityMapper {
	...
	public OrdersEntity modelToOrdersEntity(OrdersModel ordersModel) {
		...
		ordersEntity.setOrderItemList(modelToOrderItemEntities(ordersModel.getOrderItemModelList()));
	...
	public OrderItemEntity modelToOrderItemEntity(OrderItemModel OrderItemModel) {
	...
	public List<OrderItemEntity> modelToOrderItemEntities(List<OrderItemModel> orderItemModels) {
		return orderItemModels.stream().map(orderItems -> modelToOrderItemEntity(orderItems))
